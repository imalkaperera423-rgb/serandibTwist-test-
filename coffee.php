...
<head>
  ...
  <title>Fresh Coffee - Serandib Twist</title>
  <style>
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="coffee.php">Coffee & Beverages</a></li>
...
<section class="py-5">
  <div class="container">
    <h1 class="text-center mb-5 fw-bold">Premium Coffee Roasts</h1>
    <div class="row g-4">
      ...
      if ($result && $result->num_rows > 0) {
              ...
              <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                  ...
                  <div class="card-body text-center d-flex flex-column">
                    ...
                    <button class="btn btn-outline-dark mt-3" onclick="confirmOrder('<?php echo $row['name']; ?>')">Order Now</button>
                  </div>
                </div>
              </div>
              <?php
          ...
          echo "<div class='col-12 text-center'><p class='alert alert-warning'>No coffee items found in the database. Please add some via Admin Panel.</p></div>";
      }
      ?>
...
function confirmOrder(productName) {
    alert("You have selected " + productName + ".\nThis item will be added to your cart soon!");
}
</script>
