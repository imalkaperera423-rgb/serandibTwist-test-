      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="cupcakes.php">Cupcakes</a></li>
...
<section class="py-5" style="background-color: #fff5f8;">
  <div class="container text-center">
    <h1 class="display-5 mb-4 fw-bold">Our Sweet Treats</h1>
    <p class="lead mb-5">Handcrafted cupcakes made with real butter and organic spices.</p>
    ...
    <div class="row g-4">
      ...
      if ($result && $result->num_rows > 0) {
              ...
              <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                  ...
                  <div class="card-body">
                    ...
                    <button class="btn btn-sm btn-outline-danger" onclick="addNote('<?php echo $row['name']; ?>')">Order Now</button>
                  </div>
                </div>
              </div>
              <?php
          ...
          echo "<div class='col-12'><p class='alert alert-info'>No cupcakes available right now. Check back soon!</p></div>";
      }
      ?>
    </div>
  </div>
...
function addNote(name) {
    alert("Yum! You've picked the " + name + ". We'll have it ready for you soon!");
}
</script>
